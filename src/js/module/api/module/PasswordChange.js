...
const CURRENT_PASSWORD_TARGET = '.js-async-currentPassword-target'
const NEW_PASSWORD_TARGET = '.js-async-newPassword-target'
...
class PasswordChange {
   ...
   */
  async doAxios() {
    const currentPassword = document.querySelector(CURRENT_PASSWORD_TARGET).value
    const newPassword = document.querySelector(NEW_PASSWORD_TARGET).value
